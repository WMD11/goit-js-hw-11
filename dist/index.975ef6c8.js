...
var _api = require("./partials/api");
var _card = require("./partials/card");
...
var _ontop = require("./partials/ontop");
...
function onSearch(e) {
    ...
    page = 1;
    if (!searchQuery) (0, _notiflixNotifyAio.Notify).warning("Make your choice.");
    else {
        page = 1;
        galleryEl.innerHTML = "";
        (0, _api.fetchImages)({
            ...
            if (!response.data.hits.length) {
                ...
                galleryEl.innerHTML = "";
                renderMarkup(response);
                (0, _notiflixNotifyAio.Notify).success(`Hooray! We found ${response.data.totalHits} images.`);
                lightbox.refresh();
...
function renderMarkup(response) {
    const markupCards = (0, _card.createMarkup)(response);
...
function onLoadMore() {
    ...
    (0, _api.fetchImages)({
        ...
        if (page >= totalPages) {
            loadMoreBtnEl.classList.add("visually-hidden");
            (0, _notiflixNotifyAio.Notify).warning("We're sorry, but you've reached the end of search results.");
        } else (0, _notiflixNotifyAio.Notify).success(`Hooray! We found ${response.data.totalHits - perPage * (page - 1)} images.`);
    }).catch((error)=>{
        console.error(error);
    });
}
...
},{"./partials/api":"fugoI","./partials/card":"3loSA","simplelightbox":"9ydBq","simplelightbox/dist/simple-lightbox.min.css":"kaxSc","notiflix/build/notiflix-notify-aio":"eXQLZ","./partials/ontop":"yZlwD","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fugoI":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"3loSA":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{}],"yZlwD":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "onScroll", ()=>onScroll);
parcelHelpers.export(exports, "OnTopButtonClick", ()=>OnTopButtonClick);
...
function onScroll() {
    ...
    if (scrolled > coordinates) onTopButton.classList.add("on-top-button--visible");
    if (scrolled < coordinates) onTopButton.classList.remove("on-top-button--visible");
}
